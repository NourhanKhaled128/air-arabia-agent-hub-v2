...
const TOPIC = "Trade Support Team";

export default async function TradeSupportTeamDecisionTreesPage() {
  ...
  return (
    <>
      ...
      <DecisionTreeLibrary trees={trees} basePath="/TradeSupportTeam/decision-trees" />
    </>
  );
}
