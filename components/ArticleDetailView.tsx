    ...
    <>
      ...
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        {relatedDecisionTrees.length > 0 && (
          <Link
            href={`${decisionTreeBasePath}/${relatedDecisionTrees[0].slug}`}
        ...
        {confusablePointer && (
          <div className="flex items-start gap-3 rounded-2xl border border-amber-300 bg-amber-50 dark:border-amber-800 dark:bg-amber-950/30 px-6 py-4 shadow-sm">
            ...
            <p className="text-amber-900 dark:text-amber-200">
              ...
              <Link href={`${basePath}/${confusablePointer.targetSlug}`} className="font-semibold underline">
          ...
          <section>
            ...
            <div className="space-y-6">
              {relatedArticles.slice(0, 3).map((related) => (
                <ArticleCard key={related.id} article={related} basePath={basePath} />
              ))}
            </div>
          </section>
        )}
